...
LABEL com.redhat.delivery.operator.bundle="true" \
      ...
      operators.operatorframework.io.bundle.channels.v1="stable-5.2" \
      operators.operatorframework.io.bundle.channel.default.v1="stable-5.2" \
...
LABEL com.redhat.component="multicluster-engine-operator-bundle-container" \
      ...
      konflux.additional-tags="v5.2.0-6,snapshot-release-mce-52-20260824-153451-000" \
      vendor="Red Hat, Inc." \
      url="https://github.com/stolostron/mce-operator-bundle" \
      release="5.2.0-6" \
      distribution-scope="public" \
      cpe="cpe:/a:redhat:multicluster_engine:5.2::el9"
